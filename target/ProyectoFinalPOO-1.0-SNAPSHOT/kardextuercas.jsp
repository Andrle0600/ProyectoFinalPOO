...
<html lang="es">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800" style="text-align: center"><i class="fas fa-fw fa-cog"></i>
            <span>Tuercas  </span><i class="fas fa-fw fa-cog"></i></h1>
        <p class="mb-4" style="text-align: center">Información sobre ingresos y salidas del producto tuerca.</p>
        <!-- DataTales Example -->
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <%
                            List<Producto> listaTuercas = (List<Producto>) request.getSession().getAttribute("listaTuercas");
                        %>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <% if (listaTuercas != null && !listaTuercas.isEmpty()) { %>
                                <% for (int i = 0; i < listaTuercas.size(); i++) { %>
                                <%Producto pro = listaTuercas.get(i);%>
